...
<div class="main-content">
  <div class="container">
    ...
    <div class="inner-box">
      <h3>Hukum Newton</h3>
      <p>
        Hukum Newton merupakan hukum dasar yang menggambarkan hubungan antara gaya yang bekerja pada suatu benda dan gerak yang disebabkannya. Prinsip-prinsip ini dikemukakan oleh seorang ilmuwan bernama <b>Sir Isaac Newton (1643 - 1727)</b>. Terdapat tiga hukum Newton tentang gerak, yaitu:
      </p>
    </div>
    ...
    <div class="inner-box">
      ...
      <p>
        <b>Bunyi Hukum:</b><br>
        "Jika resultan gaya yang bekerja pada benda sama dengan nol, maka benda yang semula diam akan tetap diam. Sedangkan benda yang bergerak lurus beraturan akan terus bergerak lurus beraturan."
      </p>

      <p>
        Hukum ini menjelaskan bahwa setiap benda sebenarnya memiliki sifat "malas" untuk mengubah keadaannya. 
        Benda yang sedang diam akan berusaha untuk tetap diam, dan benda yang sedang bergerak akan berusaha untuk terus bergerak. 
      ...
      <p>
        ...
        Bola tersebut akan tetap diam di tempatnya dan tidak akan berpindah sendiri, kecuali ada gaya dari luar (seperti tendangan kaki) yang mengenainya. 
        Kecenderungan bola untuk tetap diam inilah bukti penerapan Hukum I Newton dalam kehidupan sehari-hari.
      </p>

      <div class="note-box">
        Hukum Newton 1 tentang sifat kelembaman benda yang cenderung mempertahankan keadaan awalnya, baik itu tetap diam atau bergerak lurus beraturan.
      </div>
    </div>
    ...
    <div class="inner-box">
      ...
      <p>
        ...
        Sederhananya, jika kamu memberikan gaya dorong yang besar pada sebuah benda, benda tersebut akan bergerak dengan percepatan yang tinggi. 
        Namun, jika benda tersebut memiliki massa yang besar (berat), maka akan lebih sulit untuk dipercepat dibandingkan benda yang ringan. 
      ...
      <p>
        ...
        Semakin kuat tendangannya (gaya semakin besar), maka bola akan melesat dengan percepatan yang semakin tinggi. 
        Sebaliknya, jika bola tersebut diganti dengan bola besi yang massanya jauh lebih besar, maka dengan kekuatan tendangan yang sama, percepatan gerak bola akan menjadi lambat.
      </p>

      <div class="note-box">
        Hukum Newton 2 tentang hubungan gaya, massa, dan percepatan benda, di mana gaya berbanding lurus dengan percepatan.
      </div>
    </div>
    ...
    <div class="inner-box">
      ...
      <p>
        ...
        Konsep utamanya adalah bahwa gaya di alam semesta selalu muncul secara berpasangan; tidak ada gaya yang bekerja sendirian. 
        Setiap kali kita memberikan aksi pada suatu benda, benda tersebut pasti akan memberikan reaksi balik kepada kita dengan kekuatan yang sama persis.
      </p>
      ...
      <p>
        Perhatikan ilustrasi di atas. Ketika bola bergerak dan menabrak tiang gawang, bola memberikan gaya dorong (aksi) pada tiang. 
        Pada saat yang bersamaan, tiang gawang memberikan gaya balasan (reaksi) yang sama besarnya terhadap bola. 
        Akibat adanya gaya reaksi inilah bola dapat memantul kembali ke arah yang berlawanan setelah menabrak tiang.
      </p>

      <div class="note-box">
        Hukum Newton 3 tentang gaya aksi dan reaksi yang selalu timbul berpasangan dengan besar yang sama namun berlawanan arah.
      </div>
    </div>
    ...
    <div class="inner-box">
      ...
      <div class="kotak-kuis">
        <p class="teks-soal">
          <b>1.</b> Ketika seorang siswa meloncat dari perahu, perahu terdorong ke arah berlawanan. Peristiwa ini menunjukkan bahwa...
        </p>
      ...
      <div class="kotak-kuis">
        <p class="teks-soal">
          <b>2.</b> Sebuah buku di atas meja tetap diam selama tidak ada gaya yang bekerja padanya. Hal ini sesuai dengan...
        </p>
      ...
      <div class="kotak-kuis">
        <p class="teks-soal">
          <b>3.</b> Sebuah bola ditendang semakin kuat sehingga bergerak semakin cepat. Pernyataan tersebut menunjukkan...
        </p>
