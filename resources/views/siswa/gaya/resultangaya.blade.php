...
<div class="main-content">
  ...
  <div class="inner-box">
    ...
    <p>
      <b>Resultan gaya</b> adalah <b>besar gabungan atau hasil penjumlahan dari seluruh gaya yang bekerja pada suatu benda</b>. 
      Kata <b>resultan</b> sendiri dapat diartikan sebagai <b>jumlah</b>, sehingga dalam mempelajari gaya, kita akan menjumlahkan gaya-gaya yang ada. 
    ...
    <p>
      ...
      Dua anak memberikan gaya dorong (\( F_1 \) dan \( F_2 \)) dari belakang, sedangkan satu anak memberikan gaya tarik (\( F_3 \)) dari depan. 
      Ketiga gaya tersebut bekerja pada garis lurus dan memiliki arah yang sama, yaitu ke kanan. 
      Karena searah, maka gaya-gaya tersebut saling menguatkan, sehingga resultan gayanya adalah hasil penjumlahan dari ketiganya (\( R = F_1 + F_2 + F_3 \)).
    </p>
      ...
      <ul>
        <li>
          Nilai Positif (+): Jika gaya-gaya tersebut bekerja secara searah (misalnya, sama-sama ke arah kanan).
        </li>
        <li>
          Nilai Negatif (-): Jika gaya bekerja berlawanan arah. Contohnya, jika \( F_1 \) ke kanan dan \( F_2 \) ke kiri, maka perhitungannya menjadi \( F_1 + (-F_2) \).
        </li>
      </ul>

      <p>
        Penting: Tanda positif dan negatif ini hanya berfungsi sebagai penanda arah, bukan berarti ada gaya yang bernilai minus secara matematis murni.
      </p>
  </div>
      ...
      <div class="container-soal">
          ...
          <div class="box-soal">
              ...
              <p>
                  ...
                  Gaya yang diberikan Fajar adalah <b>20 N</b>, sedangkan gaya yang diberikan Fadhil adalah <b>35 N</b>. 
                  Berapakah resultan gaya yang diterima meja?
              </p>
              
              <figure class="figure-soal">
                  <img src="{{ asset('aset/4.jpg') }}" alt="Ilustrasi dua anak mendorong meja searah" class="gambar-soal">
          ...
          <div class="box-soal">
              ...
              <p>
                  ...
                  Fajar mendorong ke kanan dengan gaya sebesar <b>10 N</b>, sedangkan Fadhil mendorong ke kiri dengan gaya sebesar <b>35 N</b>. 
                  Berapakah resultan gaya yang diterima meja?
              </p>

              <figure class="figure-soal">
                  <img src="{{ asset('aset/5.jpg') }}" alt="Ilustrasi dua anak mendorong meja berlawanan arah" class="gambar-soal">
    ...
    <div class="inner-box">
      ...
      <div class="container-soal">
          ...
          <div class="box-soal">
              ...
              <figure class="figure-soal">
                  <img src="{{ asset('aset/15.jpg') }}" alt="Ilustrasi dua anak mendorong meja searah" class="gambar-soal">
              </figure>
              <div class="box-jawaban">
                <span class="label-penyelesaian">Penyelesaian (Isikan jawabanmu):</span>

                <label>Resultan Gaya (N):</label>
                <input type="text" id="jawaban1" class="input-jawaban" placeholder="Masukkan hasil resultan">
          ...
          <div class="box-soal">
              ...
              <figure class="figure-soal">
                  <img src="{{ asset('aset/16.jpg') }}" alt="Ilustrasi dua anak mendorong meja berlawanan arah" class="gambar-soal">
              </figure>
              <div class="box-jawaban">
                <span class="label-penyelesaian">Penyelesaian (Isikan jawabanmu):</span>

                <label>Resultan Gaya (N):</label>
                <input type="text" id="jawaban2" class="input-jawaban" placeholder="Masukkan hasil resultan">
  ...
  <div class="bottom-nav">
    ...
    <a href="{{ url('siswa/gaya/macam-macamgaya') }}" class="nav-btn next">Materi Selanjutnya »</a>
  </div>
