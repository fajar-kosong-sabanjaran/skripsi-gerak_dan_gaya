    ...
    <main class="kuis2-main-area">
      ...
      <header class="kuis2-top-header">
        ...
        <div class="kuis2-timer-box">
          <i class="fas fa-stopwatch"></i> <span class="timer-text-hide">Sisa Waktu:</span> <span id="timer-kuis2">30:00</span>
        </div>
      ...
      <section class="kuis2-question-wrapper">
        <div class="kuis2-question-box">
          ...
          <div class="kuis2-nav-actions">
            <button class="kuis2-btn-nav prev" id="prevBtn-kuis2">← <span class="nav-text-hide">Sebelumnya</span></button>
            <button class="kuis2-btn-nav next" id="nextBtn-kuis2"><span class="nav-text-hide">Selanjutnya</span> →</button>
          </div>
        </div>
      </section>
