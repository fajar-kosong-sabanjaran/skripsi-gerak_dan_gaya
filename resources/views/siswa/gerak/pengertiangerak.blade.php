...
@section('content')
    <div class="main-content">
        <div class="container">
            ...
            <div class="inner-box">
                ...
                <p>
                    ...
                    Ketika sebuah benda mengalami pergeseran atau berpindah kedudukan, berarti benda tersebut sedang
                    bergerak.
                    Gerak merupakan salah satu fenomena alam yang dapat kita amati setiap waktu di sekitar kita.
                    Suatu benda dikatakan bergerak apabila posisinya berubah terhadap titik acuan, baik bergerak menjauh
                    maupun mendekat darinya.
                </p>
                <p>
                ...
                <p>
                    ...
                    Di sini, rumah berperan sebagai titik acuan. Karena posisi bus terus berubah menjauhi rumah seiring
                    berjalannya waktu,
                    maka bus tersebut dikatakan bergerak. <b>Jadi, gerak itu terjadi karena adanya perubahan posisi benda
                        terhadap titik acuannya.</b>
                </p>
            </div>
            ...
            <div class="inner-box">
                ...
                <p>
                    Jika dilihat dari acuan pengamatannya, gerak dapat dibedakan menjadi dua jenis, yaitu gerak semu dan
                    gerak relatif.
                </p>
                <br>
                <h4>1. Gerak Semu</h4>
                ...
                <p>
                    Pada animasi di atas, kita melihat pemandangan jalan dan pepohonan seolah-olah bergerak mundur menjauhi
                    kita.
                    Padahal sebenarnya pohon-pohon tersebut diam tertanam di tanah. Yang sebenarnya bergerak adalah kita
                    yang berada di dalam kendaraan.
                ...
                <p>
                    Berdasarkan animasi di atas, bagi anak yang duduk santai di rumput, mobil merah tersebut jelas terlihat
                    bergerak melintasinya.
                    Namun, bayangkan jika kamu adalah sopir di dalam mobil itu. Bagi kamu, teman di sebelahmu terlihat diam
                    tidak bergerak,
                    karena posisi kalian tetap sama satu sama lain selama perjalanan. Inilah yang dimaksud gerak relatif,
                    status gerak benda bergantung pada siapa yang melihatnya.
                </p>
            </div>
            ...
            <div class="inner-box">
                ...
                <p>
                    Yuk, kita uji pemahamanmu! Di bawah ini terdapat beberapa pernyataan.
                ...
                <p class="card-pool-title">Pernyataan:</p>
        ...
        <div class="bottom-nav">
            ...
            <a href="{{ url('siswa/gerak/jaraktempuhdanperpindahan') }}" id="btn-next-materi" class="nav-btn next locked">
                Materi Selanjutnya »
            </a>
        </div>
    </div>
