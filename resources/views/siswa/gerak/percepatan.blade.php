    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="inner-box">
                ...
                <p>
                    <b>Percepatan adalah besaran yang menyatakan perubahan kecepatan suatu benda dalam selang waktu
                        tertentu.</b> Karena kecepatan merupakan besaran vektor, maka percepatan juga termasuk besaran
                    vektor yang memiliki nilai dan arah. Dalam kehidupan sehari-hari, benda jarang bergerak dengan kecepatan
                    yang selalu tetap. Kadang benda bergerak semakin cepat, kadang juga semakin lambat. Perubahan inilah
                    yang disebut dengan percepatan.
                </p>
                ...
                <p>
                    Berdasarkan video di atas, terlihat sebuah mobil yang mengalami perubahan kecepatan saat melaju di jalan
                    raya. Perubahan kecepatan ini bisa berupa pertambahan kecepatan ataupun pengurangan kecepatan.
                    Berdasarkan perubahannya, percepatan dapat dibedakan menjadi dua jenis, yaitu:
                </p>
                ...
                <ul>
                    <li>
                        ...
                        <br>
                        Terjadi jika kecepatan benda bertambah setiap waktu. Pada kondisi ini, nilai percepatan adalah
                        positif. Contohnya adalah mobil yang awalnya pelan kemudian digas sehingga melaju semakin kencang.
                        <br>
                        <i>Sebagai contoh soal,</i> sebuah sepeda awalnya diam, lalu kecepatannya menjadi 10 m/s dalam 5
                        sekon. Peristiwa ini termasuk gerak dipercepat karena memiliki ciri-ciri nilai percepatan positif
                        dan benda bergerak makin cepat.
                    </li>
                    <li>
                        <b>Gerak Diperlambat</b>
                        <br>
                        Terjadi jika kecepatan benda berkurang setiap waktu. Pada kondisi ini, nilai percepatan adalah
                        negatif atau sering disebut perlambatan. Contohnya adalah mobil yang sedang melaju kencang kemudian
                        mengerem hingga berhenti di lampu merah.
                        <br>
                        <i>Sebagai contoh soal,</i> sebuah mobil melaju 20 m/s, lalu berhenti dalam 4 sekon. Peristiwa ini
                        termasuk gerak diperlambat karena memiliki ciri-ciri nilai percepatan negatif dan benda bergerak
                        makin lambat.
                    </li>
                </ul>
            </div>
            ...
            <div class="inner-box">
                ...
                <p class="catatan-percepatan">
                    Percepatan bernilai positif jika kecepatan bertambah, dan negatif jika kecepatan berkurang
                    (perlambatan).
                </p>
            </div>
        ...
        <div class="bottom-nav">
            ...
            <a href="{{ url('siswa/gerak/petunjukpengerjaan') }}" id="btn-next-materi" class="nav-btn next locked">Ke Kuis 1
                »</a>
        </div>
