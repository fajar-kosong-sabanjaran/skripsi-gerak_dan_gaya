...
@section('content')
    <div class="main-content">
        <div class="container">
            ...
            <div class="inner-box">
                ...
                <p>
                    <b>Jarak tempuh adalah panjang lintasan yang dilalui suatu benda tanpa memedulikan arah geraknya.</b>
                    Artinya, seluruh panjang jalan yang dilewati benda tersebut dihitung sebagai jarak. Sementara itu,
                    <b>perpindahan adalah jarak antara posisi awal dan posisi akhir benda dengan memperhatikan arah
                        gerak.</b> Perpindahan dapat digambarkan sebagai garis lurus terpendek yang menghubungkan posisi
                    awal dan posisi akhir. Jadi, dapat disimpulkan bahwa jarak dan perpindahan memiliki makna yang berbeda
                    meskipun keduanya sama-sama menggambarkan perubahan posisi benda.
                </p>
                ...
                <p>
                    Berdasarkan ilustrasi di atas, dimisalkan Budi pergi dari rumah ke sekolah dengan jarak 10 km. Setelah
                    sekolahnya selesai, Budi kembali lagi dari sekolah menuju ke rumah melewati jalan yang sama sejauh 10
                    km.
                    Maka perhitungannya adalah:
                    <br>
                    1. Jarak Tempuh:
                    <br>
                    Karena jarak menghitung total panjang lintasan yang dilalui, maka kita menjumlahkan perjalanan berangkat
                    dan pulang.
                    <br>
                    ...
                    2. Perpindahan:
                    <br>
                    Perpindahan hanya melihat posisi awal dan posisi akhir. Budi bermula di rumah dan berakhir kembali di
                    rumah. Karena posisi awal dan posisi akhirnya sama, maka Budi dianggap tidak mengalami perubahan posisi.
                    <br>
                    Perpindahan = 0 km.
                </p>
            </div>
            ...
            <div class="inner-box">
                ...
                <div class="kotak-instruksi">
                    ...
                    <ul>
                        ...
                        <li>Klik tombol "Mulai Animasi" untuk melihat pergerakan mobil dari awal hingga akhir dan tombol
                            "Reset" untuk mengulang animasi.</li>
                        <li>Selesaikan pertanyaan yang muncul setelah animasi selesai untuk menguji pemahamanmu.</li>
                        <li>Gunakan tombol "Tutup Sementara" jika ingin melihat lintasan kembali dan klik "Lanjutkan
                            Pertanyaan" untuk lanjut menjawab.</li>
                    </ul>
                </div>
                ...
                <div class="anim-wrapper">
                    ...
                    <div class="anim-controls">
                        ...
                        <button class="anim-btn btn-lanjut" id="btn-lanjut-kuis" style="display:none;">Lanjutkan
                            pertanyaan</button>
                    </div>
                </div>
            </div>
            ...
            <div class="inner-box">
                ...
                <p>
                    Adi sedang mempersiapkan diri untuk mengikuti lomba balap mobil di sirkuit. Satu putaran lintasan
                    memiliki panjang 110 meter.
                    Jika Adi mengendarai mobilnya sebanyak 5 putaran, maka berapakah total jarak yang ditempuh dan berapa
        ...
        <div class="bottom-nav">
            ...
            <a href="{{ url('siswa/gerak/kelajuandankecepatan') }}" id="btn-next-materi" class="nav-btn next locked">
                Materi Selanjutnya »
            </a>
        </div>
    ...
    <div class="anim-modal" id="quiz-modal">
        <div class="anim-modal-content">
            ...
            <input type="text" id="quiz-input" placeholder="Jawaban Kamu..."
