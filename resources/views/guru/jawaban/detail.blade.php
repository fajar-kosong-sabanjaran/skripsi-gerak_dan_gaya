...
@section('content')
    <div class="card-guru">
        ...
        <div class="header-title-wrapper-detail">
            <h3>Data Jawaban Latihan Siswa - {{ $judul_materi }}</h3>
        </div>

        <div class="table-controls table-controls-jawaban">
            
            <div class="nav-back-control">
                <a href="{{ route('guru.jawaban.index') }}" class="btn-aksi btn-back-jawaban">
            ...
            <div class="search-control search-control-jawaban">
                <label>
                    Cari:
        ...
        <div class="table-responsive">
            <table class="table-guru">
                ...
                <tbody id="tableBody">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="empty-row-jawaban">
        ...
        <div class="table-footer">
            ...
            <div class="pagination-buttons">
                ...
                <span id="paginationNumbers" class="pagination-numbers-jawaban"></span>
