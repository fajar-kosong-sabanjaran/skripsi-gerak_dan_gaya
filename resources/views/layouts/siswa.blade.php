    ...
    <div class="sidebar">
        ...
        <div class="submenu" id="gerak">
            ...
            <a href="{{ url('siswa/gerak/petunjukpengerjaan') }}" id="nav-kuis1"
               class="menu-link locked {{ request()->is('siswa/gerak/petunjukpengerjaan') ? 'active' : '' }}">
        ...
        <div class="submenu" id="gaya">
            <a href="{{ url('siswa/gaya/pengantargaya') }}" id="nav-pengantar-gaya" class="locked">
                Pengantar <i class="fas fa-lock"></i>
            </a>
            <a href="{{ url('siswa/gaya/pengertiangaya') }}" id="nav-pengertian-gaya" class="locked">
                Pengertian Gaya <i class="fas fa-lock"></i>
            </a> 
            <a href="{{ url('siswa/gaya/resultangaya') }}" id="nav-resultan-gaya" class="locked">
                Resultan Gaya <i class="fas fa-lock"></i>
            </a>
            <a href="{{ url('siswa/gaya/macam-macamgaya') }}" id="nav-macam-gaya" class="locked">
                Macam-Macam Gaya <i class="fas fa-lock"></i>
            </a>
            <a href="{{ url('siswa/gaya/hukumnewton') }}" id="nav-newton" class="locked">
                Hukum Newton <i class="fas fa-lock"></i>
            </a>
            <a href="{{ url('siswa/gaya/petunjukpengerjaan') }}" id="nav-kuis2" class="locked">
