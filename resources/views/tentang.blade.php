...
<head>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
    ...
    @media (max-width: 600px) {
        div:where(.swal2-container) div:where(.swal2-popup) { width: 85% !important; padding: 1em !important; }
        div:where(.swal2-container) h2:where(.swal2-title) { font-size: 1.4em !important; padding: 0.5em 0 0 !important; }
        div:where(.swal2-container) div:where(.swal2-html-container) { font-size: 0.95em !important; margin: 1em 0 !important; }
        div:where(.swal2-container) button:where(.swal2-styled) { padding: 8px 20px !important; font-size: 14px !important; }
        div:where(.swal2-container) div:where(.swal2-icon) { width: 4em !important; height: 4em !important; margin: 1em auto .5em !important; }
        div:where(.swal2-container) div:where(.swal2-icon) div:where(.swal2-icon-content) { font-size: 2.5em !important; }
    }
    </style>
</head>
<body>
    ...
    <script>
        ...
        // Logika tutup dropdown user dan menu hamburger saat klik di luar area
