...
<head>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
    ...
    /* TAB SYSTEM DAFTAR PUSTAKA & ATRIBUSI */
    .tab-container {
        display: flex;
    ...
    .pustaka-body ul { list-style-type: disc; padding-left: 20px; color: var(--text-light); line-height: 1.8; }
    .pustaka-body li { margin-bottom: 15px; font-size: 16px; }

    /* RESPONSIVE */
    .menu-toggle { display: none; flex-direction: column; cursor: pointer; gap: 5px; }
    .menu-toggle .bar { width: 25px; height: 3px; background-color: var(--primary); border-radius: 3px; transition: 0.3s; }

    @media (max-width: 850px) {
        .navbar { padding: 15px 20px; }
        .menu-toggle { display: flex; }
        .nav-links { display: flex !important; position: absolute; top: 70px; right: -100%; flex-direction: column; background: rgba(255, 255, 255, 0.98); width: 250px; text-align: center; transition: 0.4s ease-in-out; box-shadow: -5px 10px 20px rgba(0,0,0,0.05); padding: 20px 0; border-radius: 0 0 0 15px; }
        .nav-links.active { right: 0; }
        .nav-links a { margin: 15px 0; display: inline-block; }
        .nav-links .btn-masuk, .nav-links .btn-daftar { margin: 10px auto; display: inline-block; width: max-content; }
        .user-menu-container { margin-left: 0; margin-top: 10px; }
        .dropdown-logout { position: relative; top: 0; box-shadow: none; border: none; margin: 10px auto; }
        ...
        .tab-container { padding: 20px 25px 0; flex-wrap: wrap; }
    }
    </style>
</head>
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="info-box" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="tab-container">
                <button class="tab-btn active" onclick="bukaTab(event, 'tab-pustaka')">Daftar Pustaka</button>
                <button class="tab-btn" onclick="bukaTab(event, 'tab-atribusi')">Atribusi</button>
            </div>

            <div id="tab-pustaka" class="tab-content pustaka-body" style="display: block;">
                <ul>
                    <li>Inabuy, V., Sutia, C., Maryana, O. F. T., Hardanie, B. D., & Lestari, S. H. (2023). <i>Ilmu pengetahuan alam untuk SMP/MTs kelas VII (Edisi revisi)</i>. Pusat Perbukuan, Kemendikbudristek. https://buku.kemdikbud.go.id</li>
                    <li>Hardanie, B. D., Inabuy, V., Sutia, C., Maryana, O. F. T., & Lestari, S. H. (2023). <i>Buku panduan guru ilmu pengetahuan alam untuk SMP/MTs kelas VII (Edisi revisi)</i>. Pusat Perbukuan, Kemendikbudristek. https://buku.kemdikbud.go.id</li>
                    <li>Kementerian Pendidikan dan Kebudayaan. (2017). <i>Ilmu pengetahuan alam: Buku guru SMP/MTs kelas VII (Edisi revisi 2017)</i>. Pusat Kurikulum dan Perbukuan, Balitbang, Kemendikbud.</li>
                </ul>
            </div>

            <div id="tab-atribusi" class="tab-content pustaka-body">
                <ul>
                    <li>Aset gambar karakter utama yang digunakan pada bagian beranda berasal dari <b>Freepik</b>.</li>
                    <li>Aset gambar, media, serta aset video animasi dibuat menggunakan aset dari <b>Canva</b>.</li>
                </ul>
            </div>
    ...
    <script>
        ...
        // FUNGSI TAB DAFTAR PUSTAKA & ATRIBUSI
        function bukaTab(evt, namaTab) {
            ...
            // Tampilkan konten tab saat ini, dan tambahkan class 'active' ke tombol yang membukanya
